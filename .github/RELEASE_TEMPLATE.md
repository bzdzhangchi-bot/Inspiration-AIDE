...
1. Copy this file to `.github/RELEASE_NOTES_v<version>.md` for the English release note.
2. Copy the Chinese section into `.github/RELEASE_NOTES_v<version>.zh-CN.md` when a Chinese release note is needed.
3. Replace placeholders like `<version>`, `<headline>`, and artifact names.
4. If needed, publish the final body with `gh release edit v<version> --notes-file <file>`.
